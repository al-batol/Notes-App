    ...
    final List<PopupMenuItem<String>> items = menu.map((String e) {
      ...
      return PopupMenuItem(
        ...
        child: Text(
          e.tr,
          style: TextStyle(
              fontSize: controller.isLandscape ? 8.0.sp : 14.0.sp,
              ...
              children: [
                GetBuilder<HomePageController>(
                  builder: (ctr) => Container(
                    width: 100.0.wp,
                    height: controller.isLandscape ? 25.0.hp : 15.0.hp,
                    padding: EdgeInsets.only(top: 5.0.hp),
                    decoration: BoxDecoration(
                      color: Theme.of(context).primaryColor,
                      borderRadius: BorderRadius.only(
                        bottomLeft: settingsCtr.lang == 'en'
                            ? Radius.circular(20.0.wp)
                            : Radius.zero,
                        bottomRight: settingsCtr.lang == 'ar'
                            ? Radius.circular(20.0.wp)
                            : Radius.zero,
                      ),
                    ),
                          ...
                          builder: (ctr) => SizedBox(
                            ...
                            child: PopupMenuButton(
                                  ...
                                  Get.bottomSheet(
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        controller.items[1] ||
                                    value.toString() == controller.items[2]) {
                              ...
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.only(
                                  topRight: settingsCtr.lang == 'en'
                                      ? Radius.zero
                                      : Radius.circular(controller.isLandscape
                                          ? AppDimensions.responsiveWidth(40)
                                  ...
                                  bottomLeft: settingsCtr.lang == 'en'
                                      ...
                                      : Radius.circular(controller.isLandscape
                                          ? AppDimensions.responsiveWidth(40)
                                          : AppDimensions.responsiveWidth(20)),
                                  topLeft: settingsCtr.lang == 'en'
                                      ? Radius.circular(controller.isLandscape
                                          ? AppDimensions.responsiveWidth(40)
                                          : AppDimensions.responsiveWidth(20))
                                      : Radius.zero,
                                  bottomRight: settingsCtr.lang == 'en'
                                      ? Radius.circular(controller.isLandscape
                                          ? AppDimensions.responsiveWidth(40)
                                          : AppDimensions.responsiveWidth(20))
                                      : Radius.zero,
